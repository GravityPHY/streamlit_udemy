...
multiselect = st.multiselect("Choose as many columns as you want", options=df.columns[1:], default=["col2"], max_selections=3)
...
# Number input
st.divider()
num_input = st.number_input("Pick a number",
                            min_value=0,
                            max_value=10,
                            value=0,
                            step=1)
...
# Text area
st.divider()
txt_area=st.text_area("Write a prompt",height=500,placeholder="your prompt")
st.write(txt_area)